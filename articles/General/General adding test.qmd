...
# This page will act as a guide to adding and editing pages on the wiki platform

## If you want to add a new page to the wiki, head to the GitHub repository (Link located at the top right of the page). ![Github link location](tutorialimg1.png)Inside the GitHub repository find the "articles" folder. Inside the articles folder find the category folder where you want to add your article. 
...
### To add a .qmd file simply add .qmd in the file name when finalizing your file (Red box). When adding content be sure to integrated metadata from the following code block: 

``` {#metadata .HTML}
---
title: "Example title (This is the title you want the reader to see and "interact" with)"
category: "General (This category will be used to sort all articles)"
date: "25.9.2024"
---
```
